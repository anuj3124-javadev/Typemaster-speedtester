        ...
        <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
          ...
          <HStack spacing={8} alignItems={"center"}>
            ...
            fontWeight={700}fontSize={20} color='#577b87'>
              <Link to={"/testspeed/hindi"}><Text _hover={{bg:"#577b87",color:"white" ,p:2,borderRadius:10}}>Hindi Typing</Text></Link>
              <Link to={"/testspeed"}><Text _hover={{bg:"#577b87",color:"white",p:2,borderRadius:10}}>Englis Typing</Text></Link>
